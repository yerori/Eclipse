            ...
            <div class="main-header ">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="logomain">
                            <div class="logo">
                               <a href="index.html"><img src="assets/img/logo/logohilton.jpg" alt=""></a>
                            </div>
                        </div>
                    <div class="col-xl-8 col-lg-8">
                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">                                                                                                                                     
                                        ...
                                        <li><a href="blog.html">오시는 길</a></li>                                   
                        ...
                        <div class="col-xl-2 col-lg-2">
							...
							<c:if test="${sessionScope.login!=null }"> 
						       <a href="login.jsp" class="btn btn1 d-none d-lg-block ">logout</a>                        
                            </c:if>
                            </div>
    ...
    <main>
        ...
        <div class="slider-area ">
            ...
            <div class="slider-active dot-style">
                <div class="single-slider  hero-overly slider-height d-flex align-items-center" data-background="assets/img/hero/hilton.jpg" >
                    <div class="container">
                        <div class="row justify-content-center text-center">
                            <div class="col-xl-9">
                                <div class="h1-slider-caption">
                                    <h1 data-animation="fadeInUp" data-delay=".4s">top hotel in the pusan</h1>
                   ...
                   <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                       <div class="single-footer-caption mb-30">
                           <div class="footer-tittle">
                               <h4>Reservations</h4>
                               <ul>
                                   <li><a href="#">Tel: 080-682-0882</a></li>
                                   <li><a href="#">Skype: Hiltonbooking</a></li>
                                   <li><a href="#">reservations@hilton.com</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                   <div class="col-xl-3 col-lg-3 col-md-4  col-sm-5">
                       <div class="single-footer-caption mb-30">
                           <div class="footer-tittle">
                               <h4>Our Location</h4>
                               <ul>
                                   <li><a href="#">부산광역시 기장군 기장읍</a></li>
                                   <li><a href="#">기장해안로 268-32, 46083</a></li>
                               </ul>
                               Form
